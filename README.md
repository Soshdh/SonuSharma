...
- **Other Skills**: Clean Architecture, Responsive UI, API Integration  

---

## 📌 Featured Projects 🌟

### 🛒 [Flutter Shopping Demo](https://github.com/Soshdh/flutter_shopping_demo)
...
### 📱 [Flutter Social Demo](https://github.com/Soshdh/flutter_social_demo)
A mini social media app inspired by Instagram/Twitter.  
Features: User feed, Likes & Comments, Chat system.  
Status: Work in progress ✨  

---

## 🎯 Goals 🎯
- Build production‑ready apps with Flutter + Firebase  
- Contribute to open‑source projects  
- Land a Flutter Developer role (remote or onsite)  
- Keep learning and sharing knowledge 🚀  

---

## 📫 Connect With Me 🤝
- 🌐 LinkedIn: [linkedin.com/in/Soshdh](https://linkedin.com/in/Soshdh)  
- 🐙 GitHub: [github.com/Soshdh](https://github.com/Soshdh)  
- 📧 Email: soshdh@example.com  

---

⭐️ From [Soshdh](https://github.com/Soshdh)
